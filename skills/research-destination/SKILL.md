...
description: Research current destination facts for itinerary planning, including weather, opening hours, neighborhoods, transit, closures, booking requirements, and practical risks. Use when a trip depends on facts that may change or when validating a proposed activity.
---
